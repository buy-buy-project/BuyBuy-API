...
class ListaCompraSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $listas[] = ['data_lista' => '2016-07-25','consumidorID' => 1, 'recomendada' => 0, 'confirmada' => 0];
        $listas[] = ['data_lista' => '2016-07-26','consumidorID' => 1, 'recomendada' => 0, 'confirmada' => 0];
        $listas[] = ['data_lista' => '2016-07-27','consumidorID' => 1, 'recomendada' => 0, 'confirmada' => 0];
        $listas[] = ['data_lista' => '2016-07-28','consumidorID' => 1, 'recomendada' => 0, 'confirmada' => 0];
